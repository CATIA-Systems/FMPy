...
class FMU3Slave(_FMU3):
    ...
    def __init__(self, instanceName=None, **kwargs):
        ...
        self._fmi3Function('fmi3InstantiateBasicCoSimulation', [
            ...
            (fmi3Boolean,                        'visible'),
            (fmi3Boolean,                        'loggingOn'),
            (POINTER(fmi3ValueReference),        'intermediateVariablesGetRequired'),
            (c_size_t,                           'nIntermediateVariablesGetRequired'),
            (POINTER(fmi3ValueReference),        'intermediateVariablesSetRequired'),
            (c_size_t,                           'nIntermediateVariablesSetRequired'),
            (fmi3InstanceEnvironment,            'instanceEnvironment'),
            (fmi3CallbackLogMessageTYPE,         'logMessage'),
