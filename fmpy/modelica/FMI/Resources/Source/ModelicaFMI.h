...
EXPORT void* FMU_load(ModelicaUtilityFunctions_t* callbacks, const char* unzipdir, const char* modelIdentifier, int interfaceType, const char* instantiationToken, int visible, int loggingOn);
