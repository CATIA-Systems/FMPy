from ctypes import CFUNCTYPE, c_int, c_long, c_void_p, POINTER
from .libraries import sundials_cvode
from .sundials_types import sunrealtype, SUNContext
...
CVRhsFn = CFUNCTYPE(c_int, sunrealtype, N_Vector, N_Vector, c_void_p)
#
# typedef int (*CVRootFn)(sunrealtype t, N_Vector y, sunrealtype* gout,
#                         void* user_data);
CVRootFn = CFUNCTYPE(c_int, sunrealtype, N_Vector, POINTER(sunrealtype), c_void_p)
#
...
CVodeCreate.argtypes = [c_int, SUNContext]
...
CVodeInit.argtypes = [c_void_p, CVRhsFn, sunrealtype, N_Vector]
...
CVodeReInit.argtypes = [c_void_p, sunrealtype, N_Vector]
...
CVodeSVtolerances.argtypes = [c_void_p, sunrealtype, N_Vector]
...
CVodeSetMaxStep.argtypes = [c_void_p, sunrealtype]
...
CVode.argtypes = [c_void_p, sunrealtype, N_Vector, POINTER(sunrealtype), c_int]
CVode.restype = c_int
#
