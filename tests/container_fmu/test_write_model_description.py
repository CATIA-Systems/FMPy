...
def test_write_fmi2_model_description(reference_fmus_dist_dir, reference_fmus_repo_dir, work_dir):

    model_description = read_model_description(
        str(reference_fmus_repo_dir / "BouncingBall" / "FMI2.xml")
    )
    ...
    xml_b = etree.parse(reference_fmus_repo_dir / "BouncingBall" / "FMI2.xml")
...
def test_write_fmi3_model_description(reference_fmus_dist_dir, reference_fmus_repo_dir, work_dir):
